...
function bindEvents() {
  ...
  elements.functionTrigger.addEventListener("click", () => elements.functionMenu.classList.toggle("open"));
  elements.functionOptions.querySelectorAll("button").forEach((option) => option.addEventListener("click", () => {
    elements.functionSelect.value = option.dataset.value;
    elements.functionTrigger.firstChild.textContent = option.textContent + " ";
    elements.functionMenu.classList.remove("open");
